...
<div style="background: #f5f7fa; min-height: 100vh; padding: 2rem;">
    <div style="max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <h1 style="margin: 0 0 2rem 0; color: #1a1a1a;">Éditer: {{ $category->name }}</h1>
            ...
            <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="name" value="{{ $category->name }}" style="width: 100%; padding: 0.75rem; border: 1px solid #ddd; border-radius: 6px;" required>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <textarea name="description" style="width: 100%; padding: 0.75rem; border: 1px solid #ddd; border-radius: 6px; min-height: 100px;">{{ $category->description }}</textarea>
                </div>
