...
<div class="admin-body">
    <div class="container-small">
        ...
        <div class="glass-card">
            <h1>Nouvelle <span>Catégorie</span></h1>
            ...
            <form method="POST" action="{{ route('admin.categories.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="ex: Serveurs Dédiés" value="{{ old('name') }}" required>
                    @error('name') 
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" style="min-height: 120px;" placeholder="Décrivez le type d'équipements inclus dans cette catégorie...">{{ old('description') }}</textarea>
                    @error('description') 
                        <div class="error-msg"><i class='bx bx-error-circle'></i> {{ $message }}</div> 
                    @enderror
                </div>
                ...
                <button type="submit" class="btn-submit">
                    <i class='bx bx-plus-circle'></i> Créer la catégorie
                </button>
            </form>
        </div>
    </div>
