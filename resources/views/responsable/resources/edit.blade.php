...
<style>
    ...
    .bg-maintenance { background-color: #64748b !important; }
    .bg-inactive { background-color: #ef4444 !important; }
</style>

<div class="form-container">
    <div class="header-box">
        <h1 style="margin:0; font-weight: 800; color: #2c3e50;"><i class='bx bx-edit'></i> Modifier la Ressource</h1>
        <p style="margin:5px 0 0; color: #64748b;">{{ $resource->name }}</p>
    </div>
    ...
    <div class="form-box">
        ...
        <form action="{{ route('tech.resources.update', $resource->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $resource->name) }}" placeholder="Ex: Serveur Web 01" required>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="cpu" name="cpu" value="{{ old('cpu', $resource->cpu) }}" placeholder="Ex: Intel Xeon 16 cores">
                </div>

                <div class="form-group">
                    <label for="ram">Mémoire (RAM)</label>
                    <input type="text" id="ram" name="ram" value="{{ old('ram', $resource->ram) }}" placeholder="Ex: 128 GB">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="bandwidth" name="bandwidth" value="{{ old('bandwidth', $resource->bandwidth) }}" placeholder="Ex: 10 Gbps">
                </div>

                <div class="form-group">
                    <label for="capacity">Capacité de Stockage</label>
                    <input type="text" id="capacity" name="capacity" value="{{ old('capacity', $resource->capacity) }}" placeholder="Ex: 2 TB">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="os" name="os" value="{{ old('os', $resource->os) }}" placeholder="Ex: Ubuntu 22.04 LTS">
                </div>

                <div class="form-group">
                    <label for="location">Localisation</label>
                    <input type="text" id="location" name="location" value="{{ old('location', $resource->location) }}" placeholder="Ex: Salle 3, Rack 12">
                </div>
            </div>

            <div class="form-group">
                <label for="status">État de la Ressource *</label>
            ...
            <div class="btn-group">
                ...
                <form action="{{ route('tech.resources.destroy', $resource->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette ressource ?');">
                    @csrf
                    @method('DELETE')
